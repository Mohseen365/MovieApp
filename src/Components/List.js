...
export default class List extends Component {
  ...
  handleNextPage = () => {
    this.setState({ currPage: this.state.currPage + 1 }, this.getUpdatedMovies);// jab state change hoga to getUpdatedMovies fn call hoga
  };
  ...
  render() {
    ...
    return (
      // yha pr ham 2 div likh rhe he isliye fragment use kr rhe he
      <>
