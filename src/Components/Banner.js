      ...
      <>
        {this.state.movies.length == 0 ? (
          ...
          <div className="card banner-card">
            <img
              src={`https://image.tmdb.org/t/p/original/${this.state.movies[0].backdrop_path}`} //https://image.tmdb.org/t/p/original/ this is website from where i am taking images it act like database
