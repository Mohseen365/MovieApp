...
export default class Favourites extends Component {
  ...
  async componentDidMount() {
    ...
    data.data.results.map((movieObj) => {
      if (!allGenre.includes(genreId[movieObj.genre_ids[0]])) {
        allGenre.push(genreId[movieObj.genre_ids[0]]); //we will take all genres from movies and save in allGenre array
      }
    });
  ...
  render() {
    ...
    return (
        ...
        <div className="row">
          {/* bootstrap ek page ko 12 parts me divide krta he agar tumhe page ka 3 part lena he to tumhe col-4 likhna he baaki ko col-8 apne aap allot ho jayega */}
